...
![thermally grown outside top Q temperature gradient current](case_panels/thermally_grown_outside_top_Q_T_GRADIENT_CURRENT.png)

##### outside_middle

![thermally grown outside middle Q temperature gradient current](case_panels/thermally_grown_outside_middle_Q_T_GRADIENT_CURRENT.png)

##### outside_bottom

![thermally grown outside bottom Q temperature gradient current](case_panels/thermally_grown_outside_bottom_Q_T_GRADIENT_CURRENT.png)

##### edge_top

![thermally grown edge top Q temperature gradient current](case_panels/thermally_grown_edge_top_Q_T_GRADIENT_CURRENT.png)

##### edge_middle

![thermally grown edge middle Q temperature gradient current](case_panels/thermally_grown_edge_middle_Q_T_GRADIENT_CURRENT.png)

##### edge_bottom

![thermally grown edge bottom Q temperature gradient current](case_panels/thermally_grown_edge_bottom_Q_T_GRADIENT_CURRENT.png)

##### inside_top

![thermally grown inside top Q temperature gradient current](case_panels/thermally_grown_inside_top_Q_T_GRADIENT_CURRENT.png)

##### inside_middle

![thermally grown inside middle Q temperature gradient current](case_panels/thermally_grown_inside_middle_Q_T_GRADIENT_CURRENT.png)

##### inside_bottom

![thermally grown inside bottom Q temperature gradient current](case_panels/thermally_grown_inside_bottom_Q_T_GRADIENT_CURRENT.png)

#### Evaporated SiO2 interface

##### outside_top

![evaporated outside top Q temperature gradient current](case_panels/evaporated_outside_top_Q_T_GRADIENT_CURRENT.png)

##### outside_middle

![evaporated outside middle Q temperature gradient current](case_panels/evaporated_outside_middle_Q_T_GRADIENT_CURRENT.png)

##### outside_bottom

![evaporated outside bottom Q temperature gradient current](case_panels/evaporated_outside_bottom_Q_T_GRADIENT_CURRENT.png)

##### edge_top

![evaporated edge top Q temperature gradient current](case_panels/evaporated_edge_top_Q_T_GRADIENT_CURRENT.png)

##### edge_middle

![evaporated edge middle Q temperature gradient current](case_panels/evaporated_edge_middle_Q_T_GRADIENT_CURRENT.png)

##### edge_bottom

![evaporated edge bottom Q temperature gradient current](case_panels/evaporated_edge_bottom_Q_T_GRADIENT_CURRENT.png)

##### inside_top

![evaporated inside top Q temperature gradient current](case_panels/evaporated_inside_top_Q_T_GRADIENT_CURRENT.png)

##### inside_middle

![evaporated inside middle Q temperature gradient current](case_panels/evaporated_inside_middle_Q_T_GRADIENT_CURRENT.png)

##### inside_bottom

![evaporated inside bottom Q temperature gradient current](case_panels/evaporated_inside_bottom_Q_T_GRADIENT_CURRENT.png)

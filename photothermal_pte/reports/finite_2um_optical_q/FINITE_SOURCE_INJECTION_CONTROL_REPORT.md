...
## Accepted empty-stack control

The 6.8 µm aperture run with the same 2 µm waist passed every source gate:

- volume Q in the lossless stack: exactly `0 W`;
- empty six-face residual / total incident power: `3.3001e-4` (0.0330%);
- opposite x-face asymmetry: `1.7767e-8`;
- opposite y-face asymmetry: `2.0434e-8`;
- source-aperture edge / central incident intensity: `0.0431567`;
- central downward incident intensity: `6.52185260850769e-4 W/m²`;
- flake-footprint minimum / peak incident intensity: `0.600280`;
- finite-Gaussian lateral diffraction fraction: `0.0500601` (reported, not
  zeroed).

The accepted reference was generated by commit
`1ef75424eb3e3cbb42335295756f9cc43e1a1240`. No material case may use the
failed 6.0 µm-aperture reference.

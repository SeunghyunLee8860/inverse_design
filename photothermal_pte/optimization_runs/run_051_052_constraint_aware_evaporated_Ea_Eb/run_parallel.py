...
def main() -> int:
    ...
    command = [
        ...
        "--raw-ea", str(ARTIFACT_ROOT / "run051_constraint_aware_Ea_evaporated"),
        "--raw-eb", str(ARTIFACT_ROOT / "run052_constraint_aware_Eb_evaporated"),
        "--published-ea", str(HERE / "run_051_Ea_results"),
        "--published-eb", str(HERE / "run_052_Eb_results"),

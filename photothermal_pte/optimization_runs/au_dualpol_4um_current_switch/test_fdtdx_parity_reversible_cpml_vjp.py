...
from photothermal_pte.optimization_runs.au_dualpol_4um_current_switch.fdtdx_parity_reversible_cpml_vjp import (
    reversible_ade_cpml_fdtd_prototype,
)
from photothermal_pte.optimization_runs.au_dualpol_4um_current_switch.test_fdtdx_parity_reversible_cpml import (
    _small_cpml_scene,
)


def test_multistep_ADE_CPML_custom_vjp_matches_direct_c3_gradient() -> None:
    ...
    def reversible_loss(value):
        _, output = reversible_ade_cpml_fdtd_prototype(

...
1. The historical implemented relaxation was O3/TE1: optical Drude strength was rho^3, while thermal conductivity/contact and electrical conductivity/contact were linear in rho. Production code now uses a shared linear fraction, pending revalidation.
...
4. A separate, more fundamental robust-objective omission is present. The optimizer used eta=0.35 and eta=0.65 but did not include nominal eta=0.50. Under the historical O3/TE1 law, nominal Ib=+8.386359 nA and fails the requested sign.
...
The historical mismatch was O3/TE1. O1/TE1 changes only the optical relaxation; O3/TE3 changes only the thermal/electrical relaxation. O1/TE3 closes the factorial. These labels describe the historical diagnostic, not the corrected production path.

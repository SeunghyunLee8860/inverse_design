...
export LUM_RESERVE_MODULE_DIR="${LUM_RESERVE_MODULE_DIR:-/home/dhkim/dhkim_module}"
export AU_LUMERICAL_LICENSE_AUDIT_WAIT_S="${AU_LUMERICAL_LICENSE_AUDIT_WAIT_S:-120}"
export AU_LUMERICAL_LICENSE_AUDIT_POLL_S="${AU_LUMERICAL_LICENSE_AUDIT_POLL_S:-2}"

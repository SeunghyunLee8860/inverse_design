...
def main() -> int:
    ...
    package_index = {
        ...
        "periodic_scope": {
            "folder": "results_actual_metasurfaces/meeting_plot_package/periodic_canonical",
            "raw_seam_policy": "raw endpoint arrays preserved; canonical/tiled maps are display-only and never used for power metrics",
            "figures": [
                "periodic_canonical/00_periodic_structure_3x3.png",
                "periodic_canonical/01_T_Ea_periodic_Qtotal.png",
                "periodic_canonical/02_T_Eb_periodic_Qtotal.png",
                "periodic_canonical/03_bare_Ea_periodic_Qtotal.png",
                "periodic_canonical/04_bare_Eb_periodic_Qtotal.png",
                "periodic_canonical/05_periodic_vs_finite_device_scope.png",
            ],
            "scope_document": "PERIODIC_VS_FINITE_SCOPE.md",
        },
    }
    for row in rows:
        key = row["case"]

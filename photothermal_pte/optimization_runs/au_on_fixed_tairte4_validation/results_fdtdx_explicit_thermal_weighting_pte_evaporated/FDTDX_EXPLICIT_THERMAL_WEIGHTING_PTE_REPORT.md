...
Scenario: **evaporated** TaIrTe4/SiO2 contact with
`G=7.370000e+04 W/(m2 K)`.
...
The GPU solve gives `Tmax=9.156692620445e-09 K`, residual
`5.382e-10`, and energy-balance error
`0.000000%`.
...
PTE current is `3.371736983315e-17 A`; electrical residual is
`7.803e-12`.

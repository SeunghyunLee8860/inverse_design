...
| metric | value |
|---|---:|
| total P_Q | 2.477953843200e-13 W |
| independently reintegrated P_Q | 2.477953932866e-13 W |
| total reintegration error | 0.000003619% |
| worst component reintegration error | 0.000011857% |
| dual-volume factorization error | 0.000005364% |
| matched-volume Q/flux closure | 0.122366% |
| late-window change | 0.019832% |
| runtime | 120.373 s |

Material powers are Au `5.500602467429e-14 W`, TaIrTe4
`1.526980480192e-13 W`, and SiO2
`4.009132059309e-14 W`. The raw NPZ is not committed to Git. Its

#!/usr/bin/env python3
"""Append one Run 004 state and regenerate all progress artifacts."""
...
STATUS = "RUNNING_JOINT_FOM_DISK_CONSTRAINED_CONTINUATION"
...
def load_summary() -> dict[str, object]:
    ...
    return {
        ...
        "method": "joint FOM plus 500 nm disk constraints from the first iteration",
        "history": [],
        "raw_artifacts": {},
    }
...
def record(
    ...
    tag = f"run004_b{int(beta):03d}_s{stage_iteration:03d}_g{global_iteration:03d}_{role}"

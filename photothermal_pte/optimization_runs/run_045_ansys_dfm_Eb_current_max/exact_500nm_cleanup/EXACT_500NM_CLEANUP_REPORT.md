# run045_Eb exact 500 nm binary cleanup

Status: `VALIDATED_EXACT_500NM_BINARY_CLEANUP_AND_OBJECTIVE`
...
|---|---:|---:|---:|---:|---:|
| solid-first | 0 | 90 | 56.357813 nA | -0.0194% | True |
| void-first | 0 | 90 | 56.358753 nA | -0.0177% | True |

Selected candidate: `void_first`, because it has the larger recomputed objective among exact-zero candidates. The continuous reference is 56.368727 nA at 285 µW.

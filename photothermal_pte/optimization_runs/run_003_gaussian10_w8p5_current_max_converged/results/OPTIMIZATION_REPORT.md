...
Current stage: beta=32, accepted stage iteration=6, global iteration=89.

Constraint contract: `soft_disk_opening_500nm_v3_exact_nonincrease`.

Actual FOM: `8.851204178282e-07 A/W`. Fixed-cap solid/void constraints: `9.649009e-04` / `2.381998e-03` with cap `2.000000e-03`.

Exact 500 nm bad cells: solid `109`, void `315`. Stage convergence: `False` (need at least 8 accepted updates).
